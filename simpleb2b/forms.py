...
class orderproductsform(forms.ModelForm):
    ...
    aadharnumber = forms.CharField(widget=forms.NumberInput(),required=True,max_length=100)
    ...
    ifsccode = forms.CharField(widget=forms.TextInput(),required=True,max_length=100)
    ...
    class Meta:
        ...
        fields = ('name','productname','aadharnumber','address','mobilenumber','bankname','accountnumber','ifsccode','amount','date','time')
